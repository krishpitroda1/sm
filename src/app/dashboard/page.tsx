    ...
    return (
        <div className="min-h-screen bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-sky-50 to-slate-100 p-4 md:p-8 font-sans selection:bg-blue-200">
            ...
            <Dialog open={receiptModal} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-md p-0 overflow-hidden bg-slate-50 rounded-3xl border-0 shadow-2xl">
                    ...
                    {receiptPayment && (
                        <div className="p-6">
                            <div ref={receiptRef} className="bg-white border border-slate-200 rounded-2xl p-8 space-y-6 relative overflow-hidden shadow-sm">
                                {/* Watermark */}
                                ...
                                <div className="border-t border-dashed border-slate-200 my-6 relative z-10"></div>
                                ...
                                <div className="space-y-4 text-sm relative z-10">
                                    ...
                                    <div className="mt-6 bg-slate-900 text-white rounded-xl p-4 flex justify-between items-center shadow-lg shadow-slate-900/20">
                                ...
                                <div className="flex justify-center mt-8 relative z-10">
                                    <div className="border-2 border-green-500 text-green-600 rounded-lg px-8 py-2 font-black text-xl -rotate-6 inline-block bg-white/70 backdrop-blur tracking-widest shadow-sm">
                                        PAID
                                    </div>
                                </div>
                            </div>
